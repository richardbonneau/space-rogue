...
onready var alien  = load('res://Assets/Sprites/Portraits/alien.png')
onready var scientist  = load('res://Assets/Sprites/Portraits/scientist.png')
onready var bot  = load('res://Assets/Sprites/Portraits/bot.png')
